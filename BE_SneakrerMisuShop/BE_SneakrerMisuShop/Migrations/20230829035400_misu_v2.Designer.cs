...
namespace BE_SneakrerMisuShop.Migrations
{
    ...
    [Migration("20230829035400_misu_v2")]
    partial class misu_v2
    {
            ...
            modelBuilder.Entity("BE_SneakrerMisuShop.Enitites.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "001",
                            CreationTime = new DateTime(2023, 8, 29, 10, 54, 0, 76, DateTimeKind.Local).AddTicks(6131),
                            Name = "Admin",
                            Status = 1
                        },
                        new
                        {
                            Id = 2,
                            Code = "002",
                            CreationTime = new DateTime(2023, 8, 29, 10, 54, 0, 76, DateTimeKind.Local).AddTicks(6181),
                            Name = "Nhân Viên",
                            Status = 1
                        },
                        new
                        {
                            Id = 3,
                            Code = "003",
                            CreationTime = new DateTime(2023, 8, 29, 10, 54, 0, 76, DateTimeKind.Local).AddTicks(6182),
                            Name = "Khách hàng",
                            Status = 1
                        });
                });
