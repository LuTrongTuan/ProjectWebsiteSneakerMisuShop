...
{
    public partial class misu_v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypePayment = table.Column<bool>(type: "bit", nullable: true),
                    BoughtType = table.Column<bool>(type: "bit", nullable: true),
                    Total = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    FeeShiping = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CityId = table.Column<int>(type: "int", nullable: true),
                    DistrictId = table.Column<int>(type: "int", nullable: true),
                    TownId = table.Column<int>(type: "int", nullable: true),
                    AddressDetail = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Brands_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DetailSales_ProductDetails_DetailId",
                        column: x => x.DetailId,
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "Code", "CreationTime", "DeletionTime", "LastModificationTime", "Name", "Status" },
                values: new object[] { 1, "001", new DateTime(2023, 8, 29, 10, 33, 18, 110, DateTimeKind.Local).AddTicks(5281), null, null, "Admin", 1 });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "Code", "CreationTime", "DeletionTime", "LastModificationTime", "Name", "Status" },
                values: new object[] { 2, "002", new DateTime(2023, 8, 29, 10, 33, 18, 110, DateTimeKind.Local).AddTicks(5292), null, null, "Nhân Viên", 1 });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "Code", "CreationTime", "DeletionTime", "LastModificationTime", "Name", "Status" },
                values: new object[] { 3, "003", new DateTime(2023, 8, 29, 10, 33, 18, 110, DateTimeKind.Local).AddTicks(5293), null, null, "Khách hàng", 1 });
