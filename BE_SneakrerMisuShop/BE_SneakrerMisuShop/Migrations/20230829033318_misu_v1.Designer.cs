...
namespace BE_SneakrerMisuShop.Migrations
{
    ...
    [Migration("20230829033318_misu_v1")]
    partial class misu_v1
    {
            ...
            modelBuilder.Entity("BE_SneakrerMisuShop.Enitites.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "001",
                            CreationTime = new DateTime(2023, 8, 29, 10, 33, 18, 110, DateTimeKind.Local).AddTicks(5281),
                            Name = "Admin",
                            Status = 1
                        },
                        new
                        {
                            Id = 2,
                            Code = "002",
                            CreationTime = new DateTime(2023, 8, 29, 10, 33, 18, 110, DateTimeKind.Local).AddTicks(5292),
                            Name = "Nhân Viên",
                            Status = 1
                        },
                        new
                        {
                            Id = 3,
                            Code = "003",
                            CreationTime = new DateTime(2023, 8, 29, 10, 33, 18, 110, DateTimeKind.Local).AddTicks(5293),
                            Name = "Khách hàng",
                            Status = 1
                        });
                });
