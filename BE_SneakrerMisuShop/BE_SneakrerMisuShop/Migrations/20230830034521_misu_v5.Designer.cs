...
namespace BE_SneakrerMisuShop.Migrations
{
    ...
    [Migration("20230830034521_misu_v5")]
    partial class misu_v5
    {
            ...
            modelBuilder.Entity("BE_SneakrerMisuShop.Enitites.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "001",
                            CreationTime = new DateTime(2023, 8, 30, 10, 45, 21, 370, DateTimeKind.Local).AddTicks(67),
                            Name = "Admin",
                            Status = 1
                        },
                        new
                        {
                            Id = 2,
                            Code = "002",
                            CreationTime = new DateTime(2023, 8, 30, 10, 45, 21, 370, DateTimeKind.Local).AddTicks(82),
                            Name = "Nhân Viên",
                            Status = 1
                        },
                        new
                        {
                            Id = 3,
                            Code = "003",
                            CreationTime = new DateTime(2023, 8, 30, 10, 45, 21, 370, DateTimeKind.Local).AddTicks(83),
                            Name = "Khách hàng",
                            Status = 1
                        });
                });
