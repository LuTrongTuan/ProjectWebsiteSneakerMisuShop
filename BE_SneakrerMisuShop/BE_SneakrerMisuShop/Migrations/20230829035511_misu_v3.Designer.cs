...
namespace BE_SneakrerMisuShop.Migrations
{
    ...
    [Migration("20230829035511_misu_v3")]
    partial class misu_v3
    {
            ...
            modelBuilder.Entity("BE_SneakrerMisuShop.Enitites.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "001",
                            CreationTime = new DateTime(2023, 8, 29, 10, 55, 11, 289, DateTimeKind.Local).AddTicks(9298),
                            Name = "Admin",
                            Status = 1
                        },
                        new
                        {
                            Id = 2,
                            Code = "002",
                            CreationTime = new DateTime(2023, 8, 29, 10, 55, 11, 289, DateTimeKind.Local).AddTicks(9312),
                            Name = "Nhân Viên",
                            Status = 1
                        },
                        new
                        {
                            Id = 3,
                            Code = "003",
                            CreationTime = new DateTime(2023, 8, 29, 10, 55, 11, 289, DateTimeKind.Local).AddTicks(9313),
                            Name = "Khách hàng",
                            Status = 1
                        });
                });
